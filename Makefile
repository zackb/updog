...
send-test:
	curl -XPOST -i --data-binary '{"domain": "foo.com", "ref": "google.com", "path": "/hello"}' --user-agent 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.0.0 Safari/537.36' localhost:8080/view
